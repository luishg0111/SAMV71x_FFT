# 1 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
...
# 1 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
# 85 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
...
# 86 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 88 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c" 2
...
# 107 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
void TWI_ConfigureMaster( Twihs *pTwi, uint32_t dwTwCk, uint32_t dwMCk )
{
 ...
 { } ;
 ((pTwi) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 114, __FUNCTION__, "pTwi")) ;
 ...
 ((dwCkDiv < 8) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 139, __FUNCTION__, "dwCkDiv < 8")) ;
 { } ;
...
void TWI_ConfigureSlave(Twihs *pTwi, uint8_t slaveAddress)
{
 ...
 for (i=0; i < 1000000; i++);
 (((pTwi->TWIHS_CR & (0x1u << 5))!= (0x1u << 5)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 174, __FUNCTION__, "(pTwi->TWIHS_CR & TWIHS_CR_SVDIS)!= TWIHS_CR_SVDIS")) ;
}
...
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 183, __FUNCTION__, "pTwi != NULL")) ;

 pTwi->TWIHS_CR = (0x1u << 1);
}
# 197 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
void TWI_StartRead(
  Twihs *pTwi,
  uint8_t address,
  uint32_t iaddress,
  uint8_t isize)
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 203, __FUNCTION__, "pTwi != NULL")) ;
 (((address & 0x80) == 0) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 204, __FUNCTION__, "(address & 0x80) == 0")) ;
 (((iaddress & 0xFF000000) == 0) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 205, __FUNCTION__, "(iaddress & 0xFF000000) == 0")) ;
 ((isize < 4) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 206, __FUNCTION__, "isize < 4")) ;
...
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 228, __FUNCTION__, "pTwi != NULL")) ;

 return pTwi->TWIHS_RHR;
}
# 241 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
void TWI_WriteByte(Twihs *pTwi, uint8_t byte)
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 243, __FUNCTION__, "pTwi != NULL")) ;

 pTwi->TWIHS_THR = byte;
}
# 259 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
void TWI_StartWrite(
  Twihs *pTwi,
  uint8_t address,
  uint32_t iaddress,
  ...
  uint8_t byte)
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 266, __FUNCTION__, "pTwi != NULL")) ;
 (((address & 0x80) == 0) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 267, __FUNCTION__, "(address & 0x80) == 0")) ;
 (((iaddress & 0xFF000000) == 0) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 268, __FUNCTION__, "(iaddress & 0xFF000000) == 0")) ;
 ((isize < 4) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 269, __FUNCTION__, "isize < 4")) ;
...
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 323, __FUNCTION__, "pTwi != NULL")) ;
 (((sources & ( (0x1u << 0) | (0x1u << 0) | (0x1u << 1) | (0x1u << 2) | (0x1u << 4) | (0x1u << 5) | (0x1u << 6) | (0x1u << 7) | (0x1u << 8) | (0x1u << 9) | (0x1u << 10) | (0x1u << 11) | (0x1u << 16) | (0x1u << 18) | (0x1u << 19) | (0x1u << 20) | (0x1u << 21)))) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 324, __FUNCTION__, "(sources & TWIHS_IT)")) ;
...
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 336, __FUNCTION__, "pTwi != NULL")) ;
 ((sources & ( (0x1u << 0) | (0x1u << 0) | (0x1u << 1) | (0x1u << 2) | (0x1u << 4) | (0x1u << 5) | (0x1u << 6) | (0x1u << 7) | (0x1u << 8) | (0x1u << 9) | (0x1u << 10) | (0x1u << 11) | (0x1u << 16) | (0x1u << 18) | (0x1u << 19) | (0x1u << 20) | (0x1u << 21))) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 337, __FUNCTION__, "sources & TWIHS_IT")) ;

 pTwi->TWIHS_IDR = sources;
}
# 349 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
uint32_t TWI_GetStatus(Twihs *pTwi)
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 351, __FUNCTION__, "pTwi != NULL")) ;

 return pTwi->TWIHS_SR;
}
# 363 "D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c"
uint32_t TWI_GetMaskedStatus(Twihs *pTwi)
{
 uint32_t status;

 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 367, __FUNCTION__, "pTwi != NULL")) ;
...
{
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("D:\\SAMV71x_FFT\\hal\\libchip_samv7\\source\\twi.c", 382, __FUNCTION__, "pTwi != NULL")) ;
