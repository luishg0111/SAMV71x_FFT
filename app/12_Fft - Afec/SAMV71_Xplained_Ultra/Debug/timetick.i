...
uint32_t GetTicks(void)
{
 ((SysTickConfigured) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\timetick.c", 146, __FUNCTION__, "SysTickConfigured"));
...
void Wait( volatile uint32_t dwMs )
{
 ...
 ((SysTickConfigured) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\timetick.c", 161, __FUNCTION__, "SysTickConfigured"));
...
void Sleep( volatile uint32_t dwMs )
{
 ...
 ((SysTickConfigured) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\timetick.c", 178, __FUNCTION__, "SysTickConfigured"));
